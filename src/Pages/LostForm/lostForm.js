      ...
      <div className="form" style={form}>
        ...
        <Form style={form} onSubmit={this.handleSubmit}>
          <Form.Group widths='equal'>
            <Form.Field control={Input} label='Co zgubiłeś' placeholder='Co zgubiłeś' required type="text" name="itemName" value={this.state.itemName} onChange={this.handleChange} className="name" />
          ...
          <Form.Group widths='equal'>
            <Form.Field label='Gdzie zgubiłeś' control='select' required name="location" value={this.state.location} onChange={this.handleChange}>
            ...
            <Form.Field label='Co zgubiłeś' control='select' required name="category" value={this.state.category} onChange={this.handleChange}>
          ...
          <Form.Field control={TextArea} label='O przedmiocie' placeholder='Opisz zgubiony przedmiot' rows="5" cols="50" required type="text" name="description" value={this.state.description} onChange={this.handleChange} />
